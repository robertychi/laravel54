        ...
        <aside class="main-sidebar">
            ...
            <section class="sidebar">
                ...
                <ul class="sidebar-menu">
                    ...
                    <router-link to="#" tag="li" active-class="active" class="treeview active" exact>
                        <a>
                        ...
                        <ul class="treeview-menu">
                            <router-link to="/dashboard" tag="li" active-class="active" exact>
                                <a><i class="fa fa-circle-o"></i>Dashboard v1</a>
                            </router-link>
                            <router-link to="/dashboard/v2" tag="li" active-class="active" exact>
                                <a><i class="fa fa-circle-o"></i>dashboard v2</a>
                            </router-link>
                            <router-link to="/dashboard/v3" tag="li" active-class="active" exact>
                                <a><i class="fa fa-circle-o"></i>dashboard v3</a>
                            </router-link>
                            <router-link to="/" tag="li" active-class="active" exact>
                                <a><i class="fa fa-circle-o"></i>home</a>
                            </router-link>
                            <router-link to="/dashboard/examples-blank-page" tag="li" active-class="active" exact>
                                <a><i class="fa fa-circle-o"></i>Blank Page</a>
                            </router-link>
                        </ul>
                    </router-link>
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li><a href="/dashboard/examples-blank-page"><i class="fa fa-circle-o"></i> Boxed</a></li>
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li><a href="pages/examples/lockscreen.html"><i class="fa fa-circle-o"></i>
                                Lockscreen</a>
                            </li>
